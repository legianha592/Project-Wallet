  ...
  return (
    <div className={classes.root}>
      ...
      <main className={classes.content}>
        ...
        <Route path="/dashboard/createWallet">
          <FormCreateWallet />
        </Route>
        <Route path="/dashboard/createRecord">
          <FormCreateRecord />
        </Route>
        <Route path="/dashboard/updateWallet">
          <FormUpdateWallet wallet={walletForUpdate} />
        </Route>
        <Route path="/dashboard/updateRecord">
          <FormUpdateRecord record={recordForUpdate} />
        </Route>
