        ...
        {listDate.map((date, index) => (
          <TabPanel value={value} index={index}>
            {!(
              ...
              getRecordByMonth(props.records, date).length === 0
            ) && (
              <Grid item xs={12}>
                <Paper elevation={0} className={classes.reportPaper}>
                  <Grid container>
                    ...
                    <Grid item xs={6}>
                      <BlueTypography className={classes.textRight}>
                        {" "}
                        ${getInComeOfListRecord(props.records, date)}
                      </BlueTypography>
                    </Grid>
                  </Grid>
                  <Grid container>
                    ...
                    <Grid item xs={6}>
                      <RedTypography className={classes.textRight}>
                        {" "}
                        ${getOutComeOfListRecord(props.records, date)}
                      </RedTypography>
                    </Grid>
                  </Grid>
                  <Grid container>
                  ...
                  <Grid container>
                    ...
                    <Grid item xs={6}>
                      <Typography className={classes.textRight}>
                        {" "}
                        ${getSumOfListRecord(props.records, date)}
                      </Typography>
                    </Grid>
                  </Grid>
                </Paper>
            ...
            <Grid item xs={12}>
              <List className={classes.root}>
                {props.records === undefined ||
                getRecordByMonth(props.records, date).length === 0 ? ( //props.records.length === 0
                  <Paper elevation={0} className={classes.reportPaper}>
                    No data
                  </Paper>
                ) : (
